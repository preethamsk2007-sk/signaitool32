...
export const Layout: React.FC<LayoutProps> = ({ children, headerActions }) => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-sky-50 flex flex-col">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <span className="block text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em] leading-none">Intelligence</span>
            </div>
          </div>
          
          <div className="flex items-center space-x-4">
            <nav className="hidden lg:flex space-x-8 mr-6 border-r border-slate-200 pr-8">
              <a href="#" className="text-sm text-slate-500 hover:text-indigo-600 font-semibold transition-colors">Methods</a>
              <a href="#" className="text-sm text-slate-500 hover:text-indigo-600 font-semibold transition-colors">Project Info</a>
            </nav>
            {headerActions}
          </div>
        </div>
